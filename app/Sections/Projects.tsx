                ...
                {experiences.map((exp, index) => {
                    ...
                    return (
                        <div key={index}>
                            ...
                            <div className="w-full  flex flex-col experience mx-auto p-2">
                                ...
                                <div className="text-body p-5">
                                    ...
                                    <span className="flex items-center hover:cursor-pointer group opacity-80 hover:opacity-100 gap-1">
                                        ...
                                        <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" className="transition-all duration-300 group-hover:rotate-45 group-hover:text-title" height="14" width="14" xmlns="http://www.w3.org/2000/svg">
